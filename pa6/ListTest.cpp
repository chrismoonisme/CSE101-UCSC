...
int main(){
  ...
  cout << "length = " << X.length() << endl;
   ...
   cout << "equals works" << endl << endl;
   

   cout << B.findNext(5) << endl;
   cout << B << endl;
   
   //cout << "find next (5) on B works" << endl << endl;
   
   //cout << "erasing on B" << endl;
   B.eraseBefore();
   B.eraseAfter();
   ...
   //cout << "erasing on B and finding previous" << endl << endl;
   ...
   //cout << "ran insert after on A" << endl << endl;
